...
|-----------|-----|-------------|
| `Capacitacion-Meta-Ads-Inmobiliario.pdf` | **Cliente** (compartir pantalla) | 10 páginas: flujo del lead, tipos de campaña, **campañas a WhatsApp + regla de los 5 minutos + CRM con IA**, creatividades, segmentación, pixel, landing, métricas y embudo. Termina con **2 checklists entregables** (Captación de propiedades y Venta de desarrollos). |
